...
* 本仓库为RuoYi-Oracle的Spring Boot 2 的版本，保持同步更新。
...
RuoYi-Oracle 框架提供 Spring Boot 2.x / 3.x / 4.x 多版本分支的并行维护。

| 名称              | 说明                      | 地址                                                             |
| :---------------- | :------------------------ | :--------------------------------------------------------------- |
| master 默认分支   | Spring Boot 4.x (JDK 17+) | https://gitcode.com/yangzongzhuan/RuoYi-Oracle                   |
| springboot3 分支  | Spring Boot 3.x (JDK 17+) | https://gitcode.com/yangzongzhuan/RuoYi-Oracle/tree/springboot3  |
| springboot2 分支  | Spring Boot 2.x (JDK 8+)  | https://gitcode.com/yangzongzhuan/RuoYi-Oracle/tree/springboot2  |
